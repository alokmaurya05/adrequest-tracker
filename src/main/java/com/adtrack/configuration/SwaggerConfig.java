package com.adtrack.configuration;
...
public class SwaggerConfig {
    ...
    public void postConstruct() throws ClassNotFoundException {
        ...
        for (BeanDefinition beanDef : provider.findCandidateComponents("com.adtrack.resources")) {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("Customer Adtracker Services")
                .description("Track customer request")
                .version("1.0")
